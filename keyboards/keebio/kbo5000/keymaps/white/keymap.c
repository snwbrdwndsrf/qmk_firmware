...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ansi(
    ...
    DM_RSTP, KC_CAPS, _______, _______, _______, KC_PGDN, _______,                   KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, _______, _______,          _______, _______, _______,
    DM_REC1, _______,          _______, SH_CUT,  SH_COPY, SH_PSTE, _______,          _______, _______, _______, _______, _______,          _______,          _______,
    DM_REC2, _______, _______, _______, _______, _______, _______,                   _______, KC_MINS, _______, _______,                   _______, _______, _______, _______
  ),

  [2] = LAYOUT_ansi(
    _______,          _______, _______, _______, _______, _______, _______,          _______, _______,          _______, _______, _______, _______, _______, SH_PWD,  _______,
...
static uint16_t tab_unregister_code;

bool encoder_update_user(uint8_t index, bool clockwise) {
  if (index == RIGHT_HALF_ENC2) {
    if(!tabbing) {
      register_code(tab_unregister_code =
          (IS_LAYER_ON(1) ? SH_TABBING_TABS
                                : SH_TABBING_APPS));
      tabbing = true;
    }
    tabtimer = timer_read();
...
void matrix_scan_user(void) {
  if(tabbing) {
    if (timer_elapsed(tabtimer) > TABBING_TIMEOUT) {
      unregister_code(tab_unregister_code);
      tabbing = false;
    }
  }
}
